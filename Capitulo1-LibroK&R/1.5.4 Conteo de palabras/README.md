...
_Los cambios realizados en para este ejercicio se pueden observar accediendo a este [commit]()_

> Para este ejercicio, busqué realizar la mejor prueba que se me ocurrió fue la de leer el contenido de un archivo de texto con muchas palabras. Mediante un comando de bash, leer el archivo pasarle la salida al programa y luego grabar esa salida en otro archivo .txt, luego comparar la salida con el comando wc de bash para ver si la cantidad coincidia.
...
Luego `ConteoDePalabras.c` y `ConteoDePalabras.out` corresponden al programa utilizado para este ejercicio y su compilación.
